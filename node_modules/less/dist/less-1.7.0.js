...
(function(window, undefined) { //
            ...
            parsers: parsers = {
                ...
                entities: {
                    ...
                    url: function() {
                        ...
                        return new(tree.URL)((value.value != null || value instanceof tree.Variable) ? value : new(tree.Anonymous)(value), env.currentFileInfo);
                    },
                ...
                ruleProperty: function() {
                    ...
                    if ((name.length > 1) && match(/^\s*((?:\+_|\+)?)\s*:/)) {
                        ...
                        for (k = 0; k < name.length; k++) {
                            s = name[k];
                            name[k] = (s.charAt(0) !== '@') ? new(tree.Keyword)(s) : new(tree.Variable)('@' + s.slice(2, -1),
    ...
    (function(tree) {
        ...
        var colorBlendMode = {
            ...
            overlay: function(cb, cs) {
                cb *= 2;
                return (cb <= 1) ? colorBlendMode.multiply(cb, cs) : colorBlendMode.screen(cb - 1, cs);
            },
        ...
        tree.Rule.prototype = {
            ...
            eval: function(env) {
                ...
                if (typeof name !== "string") {
                    ...
                    name = (name.length === 1) && (name[0] instanceof tree.Keyword) ? name[0].value : evalName(env, name);
                }
    ...
    less.env = less.env || (location.hostname == '127.0.0.1' ||
        ...
        isFileProtocol ? 'development' : 'production');
